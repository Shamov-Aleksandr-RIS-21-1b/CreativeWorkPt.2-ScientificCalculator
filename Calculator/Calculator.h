...
#pragma endregion
	...
	private: System::Void buttonBackspace_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		do
		{
			if (SelectionEnd >= 4)
			{
				if (Expression->Text->Substring(SelectionEnd - 4, 4) == "sqrt")
				{
					Expression->Text = Expression->Text->Remove(SelectionEnd - 4, 4);
					SelectionEnd -= 4;
				}
				else if (Expression->Text->Substring(SelectionEnd - 3, 3) == "sin" || Expression->Text->Substring(SelectionEnd - 3, 3) == "cos" || Expression->Text->Substring(SelectionEnd - 3, 3) == "ctg" || Expression->Text->Substring(SelectionEnd - 3, 3) == "abs")
				{
					Expression->Text = Expression->Text->Remove(SelectionEnd - 3, 3);
					SelectionEnd -= 3;
				}
				else if (Expression->Text->Substring(SelectionEnd - 2, 2) == "tg" || Expression->Text->Substring(SelectionEnd - 2, 2) == "ln" || Expression->Text->Substring(SelectionEnd - 2, 2) == "pi")
				{
					Expression->Text = Expression->Text->Remove(SelectionEnd - 2, 2);
					SelectionEnd -= 2;
				}
				else
				{
					Expression->Text = Expression->Text->Remove(SelectionEnd - 1, 1);
					SelectionEnd -= 1;
				}
			}
			else if (SelectionEnd >= 3)
			{
				if (Expression->Text->Substring(SelectionEnd - 3, 3) == "sin" || Expression->Text->Substring(SelectionEnd - 3, 3) == "cos" || Expression->Text->Substring(SelectionEnd - 3, 3) == "ctg" || Expression->Text->Substring(SelectionEnd - 3, 3) == "abs")
				{
					Expression->Text = Expression->Text->Remove(SelectionEnd - 3, 3);
					SelectionEnd -= 3;
				}
			...
			{
				if (Expression->Text->Substring(SelectionEnd - 2, 2) == "tg" || Expression->Text->Substring(SelectionEnd - 2, 2) == "ln" || Expression->Text->Substring(SelectionEnd - 2, 2) == "pi")
				{
					Expression->Text = Expression->Text->Remove(SelectionEnd - 2, 2);
					SelectionEnd -= 2;
				}
		...
		} while (SelectionEnd > SelectionStart && SelectionEnd > 0);
